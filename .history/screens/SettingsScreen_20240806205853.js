...
import { getChapters } from "../services/dbQueries";
import { useSQLiteContext } from "expo-sqlite";

export default function SettingsScreen({ navigation }) {
  const db = useSQLiteContext();
  const { fontSize, theme, darkMode, translation, notifications } = useGlobalState();
  ...
  useEffect(() => {
    getChapters(db, testText.book, testText.chapter, setBookText);
  }, [selectedTranslation]);
