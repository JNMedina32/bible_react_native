...
export default function SettingsScreen({ navigation }) {
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <ThemeToggleButton />
      <Text></Text>
      <PillButton text="Change Font Size" onPress={() => <View>
        <TouchableOpacity onPress={() => handleFontSizeChange("decrease")}>
          <FontAwesome name="minus-cirle" size={24} color={colors.text} />
        </TouchableOpacity>
        <TouchableOpacity onPress={() => handleFontSizeChange("increase")}>
          <FontAwesome name="plus-cirle" size={24} color={colors.text} />
        </TouchableOpacity>
      </View>} />
      <PillButton
